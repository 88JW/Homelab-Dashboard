...
import { Camera, Cloud, ExternalLink, Beer, Mail, HouseHeart } from "lucide-react"
import useSWR from "swr"

const services = [
  {
    name: "HomeApp",
    description: "Obowiązki domowe",
    icon: HouseHeart,
    status: "online",
  ...
  {
    name: "Nextcloud",
    description: "Pliki i synchronizacja",
    icon: Cloud,
    status: "online",
    color: "from-sky-500 to-blue-600",
    url: "https://drive.miasoftware.pl",
